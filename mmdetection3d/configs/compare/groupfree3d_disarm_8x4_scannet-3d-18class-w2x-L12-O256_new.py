...
model = dict(
    ...
    bbox_head=dict(
        ...
        relation_module_cfg=dict(
            proposal_pickup_approach='pickup',  # FIXED
...
load_from = 'configs/groupfree3d/groupfree3d_8x4_scannet-3d-18class-w2x-L12-O256_20210702_200301-944f0ac0.pth'
